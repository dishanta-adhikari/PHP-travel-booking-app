...
$package = new PackageController($con);
$packages_result = $package->getAll();

$booking = new BookingController($con);
$bookings_result = $booking->getBookingsByUser($user_id);
?>
    ...
    <div class="container py-5">
        <div class="dashboard-header mb-4 p-4">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h3 class="mb-1">Welcome, <?= htmlspecialchars($_SESSION['user_name'] ?? '') ?>!</h3>
                    <p class="mb-0">Email: <?= htmlspecialchars($_SESSION['user_email'] ?? '') ?></p>
                </div>
        ...
        <div class="card mb-4 p-3">
            ...
            <table class="table table-bordered text-center">
                ...
                <tbody>
                    <?php $modals = "";
                    foreach ($packages_result as $row): $id = $row['package_id']; ?>
                        <tr>
                        ...
                        if (count($images) > 0) {
                            ...
                            $imageTag = "<div id='$carouselId' class='carousel slide' data-bs-ride='carousel'>
        ...
        <div class="card p-3 mb-5">
            ...
            <table class="table table-bordered text-center">
                ...
                <tbody>
                    <?php foreach ($bookings_result as $row): ?>
                        <tr>
            ...
            <div class="modal-content">
                <form method="POST" action="fake_pay">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3"><label for="card" class="form-label">Card Number</label><input type="text" class="form-control" id="card" placeholder="1234 5678 9012 3456" required></div>
                        <div class="mb-3"><label for="cvv" class="form-label">CVV</label><input type="text" class="form-control" id="cvv" placeholder="123" required></div>
                        <div class="mb-3"><label for="expiry" class="form-label">Expiry</label><input type="text" class="form-control" id="expiry" placeholder="MM/YY" required></div>
                    </div>
